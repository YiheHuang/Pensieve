...
export function SearchPage() {
  ...
  return <div className="page search-page">
      ...
      <form className="magic-search water-input-shell" onSubmit={submit}><Sparkles className="search-spark" /><input aria-label={t('唤起一段记忆', 'Call a memory')} value={filters.query} onChange={e => setFilters({ ...filters, query: e.target.value })} placeholder={t('唤起一段记忆…', 'Call a memory…')} /><button type="submit"><Search /> {t('沉入水面', 'Enter the water')}</button></form>
