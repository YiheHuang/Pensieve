# Pensieve v0.7.0 User Guide

**English** · [简体中文使用手册](使用手册.md) · [Project home](../README.en.md)

## 1. Install and begin

1. Download `Pensieve-Setup-0.7.0.exe` from the [v0.7.0 release](https://github.com/YiheHuang/Pensieve/releases/tag/v0.7.0).
...
- Memories with media dissolve images, sound, and prose into one underwater current. Images retain a cool, dim memory filter.
...
A v0.7.0 backup includes the memory database, structured metadata, encrypted media, Time Echo archives, and the encrypted parameters required for cross-device unlocking. It excludes the AI API key.
